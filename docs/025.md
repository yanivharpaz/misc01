...
AI for Technical Users (Administrators and Developers)
Get Certified (Required)
Oracle Cloud Infrastructure Generative AI Professional (7h+)

Explore Large Language Models (LLMs) in depth, including architecture, fine-tuning, embeddings, and AI agents. Gain hands-on experience with OCI Generative AI, RAG, and Oracle 23ai Database.

Oracle AI Agent Studio for Fusion Applications Foundation (3h)

Explore the core concepts and features of AI Agent Studio, focusing on building and deploying "fusion native" AI agents that leverage existing business objects, security layers, and workflows within Oracle Fusion Applications.
